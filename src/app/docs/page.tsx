...
export default function DocsPage() {
    ...
    return (
        <main className="min-h-screen bg-black pt-20 pb-28 sm:pb-16">
            <div className="max-w-4xl mx-auto px-6">
                ...
                <section className="rounded-2xl border border-white/[.12] bg-zinc-900 p-6 sm:p-8 shadow-sm">
                    ...
                    <div className="mt-4 rounded-xl bg-zinc-950 border border-dashed border-white/[.1] p-4">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/[.2] text-sm sm:text-base text-white bg-zinc-900 hover:bg-zinc-800 transition-colors cursor-pointer"
                            >
                                Download PDF
                            </a>
                        </div>
