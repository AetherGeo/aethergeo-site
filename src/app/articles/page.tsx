...
export default function ArticlesPage() {
    ...
    return (
        <>
            <div className="min-h-screen bg-black pt-24 pb-28 sm:pb-12 px-4 sm:px-6">
                <div className="max-w-5xl mx-auto space-y-8">

                    {/* Container 1: Cite our Work */}
                    <div className="bg-zinc-900 rounded-2xl border border-white/[.08] shadow-xl p-8 sm:p-10">
                        ...
                        <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between bg-black/50 border border-white/[.05] rounded-xl p-6">
                            ...
                            <div className="flex flex-wrap gap-4 w-full lg:w-auto flex-shrink-0">
                                <a
                                    ...
                                    className="flex-1 lg:flex-none inline-flex items-center justify-center px-6 py-2.5 rounded-full border border-white/[.2] text-white font-semibold hover:bg-zinc-800 transition-colors gap-2"
                                >
                                    Link
