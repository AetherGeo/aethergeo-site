...
export default function Home() {
    ...
    return (
        <>
            <div className="min-h-screen bg-zinc-50 font-sans dark:bg-black pt-16 pb-12 sm:pb-0">
                {/* Hero Section with Globe */}
                <section className="relative w-full min-h-[700px] flex items-end justify-center overflow-hidden bg-white dark:bg-black">
                    <div className="absolute inset-0 z-0">
                        <Globe3D />
                    </div>

                    <div className="relative z-10 max-w-3xl mx-auto px-6 text-center pb-20 pointer-events-none">
                        <h1 className="text-5xl sm:text-6xl font-bold leading-tight tracking-tight text-black dark:text-white mb-6 drop-shadow-lg">
                            Welcome to AetherGeo
                        </h1>
                        <p className="text-xl leading-relaxed text-zinc-700 dark:text-zinc-300 mb-8 max-w-2xl mx-auto drop-shadow-md">
                ...
                <section className="relative max-w-6xl mx-auto px-6 py-14 -top-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-6 rounded-xl bg-white dark:bg-zinc-900 border border-black/[.08] dark:border-white/[.08]">
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-2xl sm:text-3xl font-semibold text-black dark:text-white mb-4">
                        ...
                        <div className="flex justify-center gap-4 mt-4">
                            <button
                                ...
                                className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-black/[.08] dark:border-white/[.2] text-lg font-semibold text-black dark:text-white bg-white dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
                            >
                                Contact Us
                            </button>
